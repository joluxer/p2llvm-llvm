...
P2ToolChain::P2ToolChain(const Driver &D, const llvm::Triple &Triple,
                        const ArgList &Args) : BareMetal(D, Triple, Args) {
...
void P2ToolChain::AddClangCXXStdlibIncludeArgs(const llvm::opt::ArgList &DriverArgs,
    ...
    llvm::sys::path::append(P, "../include", getTriple().str(), "c++/v1");
...
void P2ToolChain::addClangTargetOptions(const ArgList &DriverArgs,
                                            ...
                                            Action::OffloadKind ok) const {
    BareMetal::addClangTargetOptions(DriverArgs, CC1Args, ok);
