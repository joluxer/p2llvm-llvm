...
namespace llvm {
    ...
    class P2Subtarget : public P2GenSubtargetInfo {
        ...
        // Generated by TableGen from FeatureAtomicStoreLock in P2.td.
        // true = atomic stores use LOCKTRY/LOCKREL (safe default).
        // false = atomic stores emit plain WRLONG (opt-out via -mno-atomic-store-lock).
        bool hasAtomicStoreLock = true;

    public:
        // implementation generated in P2GenSubtargetInfo.inc
        void ParseSubtargetFeatures(StringRef CPU, StringRef TuneCPU, StringRef FS);

        // Returns true if atomic stores must participate in the lock protocol.
        // Controlled by +/-atomic-store-lock subtarget feature.
        bool useAtomicStoreLock() const { return hasAtomicStoreLock; }
